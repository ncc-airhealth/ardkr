...
- "적절한 순간에 skill 트리거"는 **순간 인식에 의존**해 약하므로, 트리거는 **신뢰할 수 있는 경계**에 건다.
- 두 층을 둔다.
- 2026-07-21 CI를 도입하지 않기로 확정하면서 CI 기반 "PR 냄새 게이트" 층은 제거했다 ([/decisions/reproducibility.md](/decisions/reproducibility.md)).
